...
<body>
    ...
    <div class="container">
        <h1 class="text-center mb-4">Explore Buildings by Barangay</h1>
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col">
                <div class="card h-100 barangay-card">
                    <div class="card-body">
                        <h5 class="card-title"><?php echo htmlspecialchars($barangay); ?></h5>
                        <a href="barangay.php?name=<?php echo urlencode($barangay); ?>" class="btn btn-primary">View Buildings</a>
                    </div>
                </div>
            </div>
            <?php endforeach; ?>
